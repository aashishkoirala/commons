/*******************************************************************************************************************************
 * AK.Commons.Web.ResourceMapping.ResourceMap
...
namespace AK.Commons.Web.ResourceMapping
{
    ...
    {
        public static IResourceMapForUser<TUserId> User<TUserId>(Func<HttpControllerContext, TUserId> userIdAccessor)
        {
            if (userIdAccessor == null) throw new ArgumentNullException("userIdAccessor");

            return new ResourceMapForUser<TUserId>(null, userIdAccessor);
        }
    }
}